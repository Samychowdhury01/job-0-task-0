        ...
        <div className="flex flex-col md:flex-row md:items-center">
          ...
          <div className="flex-1 space-y-5">
            ...
            <Textarea
              ...
              className="w-full"
            />
            <Button radius="none" className="w-full dark:bg-dark-primary dark:text-dark-accent" color="secondary">
              Send Message
            </Button>
          </div>
        </div>
        {/* image container */}
        <div className="flex flex-col md:flex-row md:items-center gap-10 mt-16">
