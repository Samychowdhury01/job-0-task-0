      ...
      <Container>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-5 mb-10">
          <div className="space-y-5">
            <h3 className="text-2xl font-bold text-secondary dark:text-dark-primary">
              Explore
            </h3>
            <ul className="text-secondaryForeground dark:text-gray-400 space-y-5">
              <li>
        ...
        <div className="flex items-center justify-center">
          <div>
            ...
            <p className="text-secondaryForeground dark:text-gray-400">
